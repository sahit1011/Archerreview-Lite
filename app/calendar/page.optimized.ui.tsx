...
import LazyTaskDetailPopover from '@/components/calendar/TaskDetailPopover';
...
interface CalendarUIProps {
  ...
  handleTaskUpdate: (taskId: string, startTime: Date, endTime: Date) => Promise<any>;
  handleAddTask: (date: Date) => void;
  handleFilterChange: (filters: FilterOptions) => void;
  goToPreviousDay: () => void;
  toggleDatePicker: () => void;
  goToNextDay: () => void;
  goToToday: () => void;
  handleTaskStatusChange: (taskId: string, status: string) => Promise<any>;
  handleCreateTask: (taskData: any) => Promise<void>;
  setResetConfirmOpen: (open: boolean) => void;
  setIsTaskCreationModalOpen: (open: boolean) => void;
  handleResetSchedule: () => Promise<void>;
}
