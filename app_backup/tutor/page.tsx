...
export default function TutorPage() {
  return (
    <Suspense fallback={
      <div className="h-[calc(100vh-64px)] overflow-hidden bg-card-background-dark flex flex-col items-center justify-center">
        <div className="w-16 h-16 border-t-4 border-archer-bright-teal border-solid rounded-full animate-spin"></div>
        <p className="mt-4 text-archer-light-text">Loading AI Tutor...</p>
      </div>
    }>
      <TutorContent />
    </Suspense>
