  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={isLoading}
        className="flex items-center px-3 py-1.5 bg-primary/10 text-primary border border-primary/40 rounded-lg hover:bg-primary/15 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-0 disabled:opacity-50 transition-colors"
      >
        {isLoading ? (
          <>
