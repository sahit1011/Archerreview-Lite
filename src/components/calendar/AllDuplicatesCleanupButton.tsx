  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={isLoading}
        className="flex items-center px-4 py-2 bg-red-500/15 text-red-300 border border-red-500/30 rounded-lg hover:bg-red-500/25 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:ring-offset-0 disabled:opacity-50 transition-colors"
      >
        {isLoading ? (
          <>
